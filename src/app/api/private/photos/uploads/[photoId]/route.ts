...
/** Compatibility endpoint for clients cached before Photos gained image groups. */
export async function PUT(
  ...
  try {
    await uploadPhotoImage(photoId, photoId, requestId, body.bytes, contentType, variant);
