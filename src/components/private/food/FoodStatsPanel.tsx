...
export function FoodStatsPanel({ statistics }: { statistics: FoodStatistics }) {
  ...
  return (
    <section aria-labelledby="food-stats-title" className="rounded-[1.75rem] border border-[#d4ccbf] bg-[#eee8de] px-5 py-8 shadow-[0_14px_42px_rgba(55,47,38,0.08)] sm:px-8 sm:py-10">
